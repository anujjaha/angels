        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" id="navbar">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="">
                    <?php
                    echo $this->Html->image('admin/logo.png',array('width'=>250,'height'=>250));
                    ?>
                </a>
            </div>
            <!-- end navbar-header -->
        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li class="selected">
                        <a href="http://localhost/cybadmin/admin-2/index.html"><i class="fa fa-dashboard fa-fw"></i>Dashboard</a>
                    </li>
                    <li>
                    ...
                    <li>
                    <a href="admins/memorials"><i class="fa fa-bar-chart-o fa-fw"></i>
